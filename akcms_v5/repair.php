...
if($dataversion < '5.1.4') {
	setsetting('customquickoperate', fromgbk("<a href=\"index.php?action=newitem&module=1\">添加内容</a>\n<a href=\"http://www.akhtm.com/manual/index.htm\" target=\"_blank\">AKCMS手册</a>\n<a href=\"index.php?file=account&action=logout&vc=[vc]\" target=\"_parent\">退出</a>"));
}
