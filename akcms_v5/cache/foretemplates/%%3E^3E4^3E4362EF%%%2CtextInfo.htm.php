<?php /* Smarty version 2.6.13, created on 2014-11-28 06:55:13
         compiled from %2CtextInfo.htm */ ?>
<!DOCTYPE html>
            ...
            <div class="span12">
                <nav id="menu" class="clearfix">
                    <ul>
                        ...
                        <li class="current"><a href="./blog-sidebar-right.html"><span class="name">Blogs</span></a>
                            <ul>
...
<section class="breadcrumbs">
    <div class="container">
        <div class="page-header">
            <div class="row">
                <div class="span8">
                    <h1>Lorem ipsum dolor sit amet consectetur <small>/ Phasellus erat felis</small></h1>
