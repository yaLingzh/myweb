...
$this->_smarty_include(array('smarty_include_tpl_file' => "head.htm", 'smarty_include_vars' => array('title' => $this->_tpl_vars['themename'],'startinstall' => 1)));
...
<noscript>
	<?php echo $this->_tpl_vars['lan']['noscripttip']; ?>

</noscript>
	<div class='install-warp'>
		<div class='install-title'><h3><?php echo $this->_tpl_vars['themename'];  echo $this->_tpl_vars['lan']['sysinstallguide']; ?>
</h3></div>
		<div class='install-content'>
			<ol class='install-step'>
				<li class='step-li'><?php echo $this->_tpl_vars['lan']['licenseagreement']; ?>
</li>
				<li class='step-li'><?php echo $this->_tpl_vars['lan']['dbsettings']; ?>
</li>
				<li class='step-li'><?php echo $this->_tpl_vars['lan']['install']; ?>
</li>
				<li class='step-li'><?php echo $this->_tpl_vars['lan']['complete']; ?>
</li>
			</ol>
		</div>
		<div class='switch license-warp'>
			<div class='warp license'>
				<div style="height:44px;color:red;"><?php echo $this->_tpl_vars['checkinstallpath']; ?>
 <a href="index.php?file=install&action=movedir">[<?php echo $this->_tpl_vars['lan']['movesubdir']; ?>
]</a></div>
				...
				<div id='isagree-license'>
					<?php echo $this->_tpl_vars['lan']['offlinelicense']; ?>
(<a href='http://www.akhtm.com/license/install.htm' target='_blank'>http://www.akhtm.com/license/install.htm</a>)<br />
					<input type="checkbox" id="agree" value="1" checked="checked" />
					<label for="agree"><?php echo $this->_tpl_vars['lan']['agree']; ?>
</label>
				</div>
			</div>
		</div>
		<div class='switch database'>
			<div class='select-other-db'>
				<a href='javascript:;'><?php echo $this->_tpl_vars['lan']['currentdbtype']; ?>
(<span id="currentdbtype">MySQL</span>) <?php echo $this->_tpl_vars['lan']['selectotherdbtype']; ?>
</a>
				<!--start:choosedbtype-->
				<div class='select-db' style='display:none;'>
					<div class='select_contents'>
						<select id="dbtype" size="10">
							<?php echo $this->_tpl_vars['drivers']; ?>
			...
			<div class='sqliteinfo warp inputinfo' style='margin-top:40px;display:none;'>
				<table>
					<tr>
						<td><?php echo $this->_tpl_vars['lan']['dbname']; ?>
</td>
						<td><input name="dbname" type="text" id="sqlitedbname" value="<?php echo $this->_tpl_vars['sqlitedbname']; ?>
" class="mustoffer sqliteoffer" size="30" /></td>
					</tr>
					<tr>
						<td><?php echo $this->_tpl_vars['lan']['tablepre']; ?>
</td>
						<td><input name="tablepre" type="text" id="sqlitetablepre" value="ak" class="mustoffer sqliteoffer" size="10" /></td>
					</tr>
					<tr>
						<td><?php echo $this->_tpl_vars['lan']['charset']; ?>
</td>
			...
			<div class='mysqlinfo inputinfo' style='margin-top:40px;'>
				<table>
					...
					<tr>
						...
						<td id="mysqlcharset"><?php echo $this->_tpl_vars['charsethtml']; ?>
</td>
					</tr>
				</table>
			</div>
			...
			<div class='warp' style='margin-top:10px;'>
				<div class='install-progress-bar'>					
					...
					<div style='width:150px;float:right;text-align:right;margin-top:10px;'>
						<?php echo $this->_tpl_vars['lan']['finished']; ?>
 <span id="percentspan">0.00</span> %&nbsp;[<a href="javascript:document.location.reload();"><?php echo $this->_tpl_vars['lan']['refresh']; ?>
		...
		<div class='switch install-complete' style='display:none;'>
			<div class='warp'>
				<div>
					<p id='thtip'><?php echo $this->_tpl_vars['sysname'];  echo $this->_tpl_vars['lan']['properlysave']; ?>
</p>
					<h1 id='oneh1' style=''><?php echo $this->_tpl_vars['lan']['systeminfo']; ?>
</h1>
						<p><?php echo $this->_tpl_vars['lan']['faddr']; ?>
<a class='path' href='<?php echo $this->_tpl_vars['cfpath']; ?>
' target='_blank'><?php echo $this->_tpl_vars['cfpath']; ?>
</a></p>
						<p><?php echo $this->_tpl_vars['lan']['cpaddr']; ?>
<a class='path' href='<?php echo $this->_tpl_vars['cppath']; ?>
' target='_blank'><?php echo $this->_tpl_vars['cppath']; ?>
</a></p>
						<p><?php echo $this->_tpl_vars['lan']['cpadmin']; ?>
admin</p>
						<p><?php echo $this->_tpl_vars['lan']['cppw']; ?>
</p>
				</div>
		...
		<div class='warp install-bottom'>
			<?php if ($this->_tpl_vars['hastheme']): ?>
				<p class='core'><?php echo $this->_tpl_vars['themename']; ?>
<a target='_blank' href='http://www.akhtm.com'><?php echo $this->_tpl_vars['lan']['basedon']; ?>
AKCMS<?php echo $this->_tpl_vars['sysedition'];  echo $this->_tpl_vars['lan']['kernel']; ?>
</a></p>
			<?php endif; ?>
			<div class='step-btn'>
				<ul class='step-btn-con'>
					<li class='next'>
						<button onclick='return false;'><?php echo $this->_tpl_vars['lan']['next']; ?>
</button>
						<!--<a href='javascript:;'><?php echo $this->_tpl_vars['lan']['next']; ?>
</a>-->
					</li>
				</ul>
			</div>
	...
	<input type="hidden" id='timediff' name="timedifference" class="mustoffer" value="<?php echo $this->_tpl_vars['timedifference']; ?>
" />
...
$(document).ready(function(){
	...
	var df = Math.round((dateline - <?php echo time(); ?>) / 3600) + 8;
	...
	$(".select-db").change(function(){
		...
		$(".select-db").hide();
		var charsethtml = "<?php echo $this->_tpl_vars['charsethtml']; ?>
";
...
function insertcustomstep() {
	if($(".other-settings").length > 0) {
		$(".step-li").eq(1).after("<li class='step-li'><?php echo $this->_tpl_vars['lan']['themename'];  echo $this->_tpl_vars['lan']['set']; ?>
</li>");
	}
...
function checkinstallprepare(data, pid) {
	if(pid == 'checkdbconnect') {
		if(data == "dbname") {
			alert("<?php echo $this->_tpl_vars['lan']['dbnameerror']; ?>
");
		}
		if(data != "ok") {
			alert("<?php echo $this->_tpl_vars['lan']['connecterror']; ?>
" + data);
			return 'fail';
		}
		...
		if(data == "ok") {
			...
			alert("<?php echo $this->_tpl_vars['lan']['error']; ?>
:" + data);
		}
	}
	return;
...
function nextclickcontrol() {
	if(currentstep == 0) {
		if($("#agree").attr("checked") == true || $("#agree").attr("checked") == "checked") {
			...
			alert('<?php echo $this->_tpl_vars['lan']['mustagree']; ?>
');
		}
	}
	if(currentstep == 1) {
...
function makesuredb() {
	...
	if(databasetype == 'sqlite') {
		if(PostData.dbname == '') {return '<?php echo $this->_tpl_vars['lan']['pleaseinputdbname']; ?>
';}
	} else if(databasetype == 'mysql') {
		if(PostData.dbhost == '') { return '<?php echo $this->_tpl_vars['lan']['pleaseinputdbhost']; ?>
';}
		if(PostData.dbuser == '') {return '<?php echo $this->_tpl_vars['lan']['pleaseinputdbuser']; ?>
';}
		if(PostData.dbname == '') {return '<?php echo $this->_tpl_vars['lan']['pleaseinputdbname']; ?>
';}
	}
...
function installcomplete(){
	$(".step-btn-con").empty().append('<li class="up"><button onclick="return false;"><?php echo $this->_tpl_vars['lan']['complete']; ?>
</button></a></li>');
