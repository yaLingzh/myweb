...
if(!isset($post_setting_submit)) {
	...
	if($get_action == 'front') {
		...
		$str_settings .= inputshow($settings, array('keywordslink', 'globalkeywordstemplate', 'statcode', 'ifcommentrehtml'));
		$str_settings .= table_end();
	}
